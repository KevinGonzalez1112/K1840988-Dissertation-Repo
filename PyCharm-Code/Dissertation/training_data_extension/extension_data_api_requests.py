...
def get_training_extension_articles():
    ...
    file = open('json_files/JSON_TRAIN_EXTENSION_ARTICLES.json')
...
def get_training_extension_data():
    dataframe_data = []

    # Get the list of articles

    articles = get_training_extension_articles()
    ...
    for article in articles:
        ...
        print(article + ' ' + str(0) + ' ' + str(anon_revisions) + ' ' + str(bot_count))
    ...
    articles_df.to_csv(r'C:\Users\Kevin\Desktop\EXTENSION-DATA-2.csv', index=False, header=True)
