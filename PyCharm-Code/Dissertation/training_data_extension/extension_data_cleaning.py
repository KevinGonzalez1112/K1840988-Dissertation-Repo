...
def extension_data_cleaning():
    # Reading in initial CSV file

    df = pd.read_csv(r'C:\Users\Kevin\Desktop\DISSERTATION-EXTENSION-DATA-1.csv')
    ...
    df.to_csv(r'C:\Users\Kevin\Desktop\EXTENSION-DATA-1-CLEAN.csv', index=False, header=True)
