...
def json_training_data_to_dictionary():
    # Open the JSON file

    file = open('json_files/JSON_TRAIN_DATA.json')
    ...
    articles_df.to_csv(r'C:\Users\Kevin\Desktop\TRAINING-DATA-1.csv', index=False, header=True)
