...
def training_data_cleaning():
    # Reading in initial CSV file

    df = pd.read_csv(r'C:\Users\Kevin\Desktop\DISSERTATION-DATA-1.csv')
    ...
    df.to_csv(r'C:\Users\Kevin\Desktop\TRAINING-DATA-1-CLEAN.csv', index=False, header=True)
